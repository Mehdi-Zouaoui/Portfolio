          ...
          <div className={styles.profil}>
            <div className={styles.catchphrase}>
              ...
              <p className={styles.presentation_profession}>
                Développeur d'application web spécialisé dans React et Next.js.
              </p>
            </div>
          </div>
          ...
          <div className={styles.details_container}>
            <div className={styles.details_content}>
              ...
              <p className={styles.about_text}>
                ...
                en utilisant les dernières technologies. Je maitrise JavaScript,
                React, Next.js et d'autres bibliothèques associées. <br /> Je
                suis également capable de travailler avec des API REST/GRAPHQL
                et de les intégrer à des applications React. J'aime travailler
                en équipe et je suis capable de communiquer efficacement pour
                résoudre les problèmes rapidement et efficacement.
              </p>
              <div className={styles.technologies_container}>
                <h2 className={styles.technologies_title}>
                  Ce que je maitrise
                </h2>
